...
aa_train=index_encode('../../data_preprocessing/processed_database/train_dataset.fasta')
print(aa_train.shape)
np.save('aa_train.npy', aa_train)

aa_test=index_encode('../../data_preprocessing/processed_database/test_dataset.fasta')
print(aa_test.shape)
np.save('aa_test.npy', aa_test)
