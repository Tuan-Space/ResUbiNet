...
for length in range(7, 70, 2):
    ...
    f_name = f'test_dataset_{length}'

    seq_path = "../../data_preprocessing/processed_database/"+f_name+".fasta"
    ...
    per_residue = False
    per_residue_path = "./"+f_name+".h5" # where to store the embeddings

    # whether to retrieve per-protein embeddings
    # --> only one 1024-d vector per protein, irrespective of its length
    per_protein = True
    per_protein_path = "./"+f_name+"_per_protein.h5" # where to store the embeddings
